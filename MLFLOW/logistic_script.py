...
def process_data():
    ...
    with mlflow.start_run():
        ...
        features_file_path = os.path.join(os.getcwd(), 'processed_features.csv')
        target_file_path = os.path.join(os.getcwd(), 'processed_target.csv')
...
## --------------------- Modeling ---------------------------- ##
def train_model(X_train, y_train, X_test, y_test, plot_name, C):
    mlflow.set_experiment('CarPrices-processing')
    with mlflow.start_run() as run:
        mlflow.set_tag('classifier', 'logistic')
